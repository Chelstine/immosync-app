                    ...
                    <div className="space-y-6 relative">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mb-2">Récupérez le dossier <code>ImmoSync-Agent.zip</code>.</p>
                                <Button
                                    size="sm"
                                    onClick={() => window.open('/ImmoSync-Agent.zip', '_blank')}
                                    className="bg-blue-100 text-blue-700 hover:bg-blue-200 w-full"
                                >
                                    <Download size={14} className="mr-2" /> Charger le ZIP
                                </Button>
                            </div>
                        </div>
