...
export default function Sidebar({ user, onClose }) {
    ...
    return (
        <div className="flex flex-col h-full bg-white border-r">
            {/* Mobile Close Button (Optional cosmetic, but overlay handles it mostly) */}

            {/* Top Left Logo Area */}
            <div className="flex items-center h-16 flex-shrink-0 px-4 bg-white border-b justify-between">
